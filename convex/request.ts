...
export const create = mutation({
    ...
    handler: async (ctx, args) =>{
        ...
        if(!currentUser){
            throw new ConvexError("User not Found : (Notice: For sending a request user must have a account on this platform)");
        }
        ...
        db.query("requests").withIndex("by_receiver_sender", (q) => q.eq
        ...
        .withIndex("by_receiver_sender", (q) => 
            ...
            if(requestAlreadyReceived){
                throw new ConvexError("Request already received from this user")
        }
        ...
        if(
         friends1.some((friend) => friend.user2 === receiver._id) || friends2.some((friend) => friend.user1 === receiver._id) 
            ...
            throw new ConvexError("You are already friends yrrrr!")
        }
...
export const accept = mutation({
    args: {
        ...
        if(!request || request.receiver !== currentUser._id){
            throw new ConvexError("There was an error accepting this error")
        }
