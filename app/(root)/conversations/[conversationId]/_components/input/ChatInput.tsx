...
const ChatInput = () => {
  ...
  return <Card className='w-full p-2 rounded-lg relative'>
    <div className="p-2 w-full rounded-lg relative">
        <div className='flex gap-2 items-end w-full'>
            <Form {...form}>
              <form
              onSubmit={form.handleSubmit(handleSubmit)} className='flex gap-2 items-end w-full'
              > 
              <FormField control = {form.control} name= "content" render ={({field})=>{
                return <FormItem className='h-fulll w-full'>
                    <FormControl>
                         ...
                         placeholder='Type a message...' className='min-h-full
                         w-full resize-none border-0 outline-0 bg-card
